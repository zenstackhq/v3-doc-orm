...
export type CommentsFindManyArgs = $FindManyArgs<$Schema, "Comments">;
export type CommentsFindUniqueArgs = $FindUniqueArgs<$Schema, "Comments">;
export type CommentsFindFirstArgs = $FindFirstArgs<$Schema, "Comments">;
export type CommentsExistsArgs = $ExistsArgs<$Schema, "Comments">;
export type CommentsCreateArgs = $CreateArgs<$Schema, "Comments">;
export type CommentsCreateManyArgs = $CreateManyArgs<$Schema, "Comments">;
export type CommentsCreateManyAndReturnArgs = $CreateManyAndReturnArgs<$Schema, "Comments">;
export type CommentsUpdateArgs = $UpdateArgs<$Schema, "Comments">;
export type CommentsUpdateManyArgs = $UpdateManyArgs<$Schema, "Comments">;
export type CommentsUpdateManyAndReturnArgs = $UpdateManyAndReturnArgs<$Schema, "Comments">;
export type CommentsUpsertArgs = $UpsertArgs<$Schema, "Comments">;
export type CommentsDeleteArgs = $DeleteArgs<$Schema, "Comments">;
export type CommentsDeleteManyArgs = $DeleteManyArgs<$Schema, "Comments">;
export type CommentsCountArgs = $CountArgs<$Schema, "Comments">;
export type CommentsAggregateArgs = $AggregateArgs<$Schema, "Comments">;
export type CommentsGroupByArgs = $GroupByArgs<$Schema, "Comments">;
export type CommentsWhereInput = $WhereInput<$Schema, "Comments">;
export type CommentsSelect = $SelectInput<$Schema, "Comments">;
export type CommentsInclude = $IncludeInput<$Schema, "Comments">;
export type CommentsOmit = $OmitInput<$Schema, "Comments">;
export type CommentsGetPayload<Args extends $SelectIncludeOmit<$Schema, "Comments", true>, Options extends $QueryOptions<$Schema> = $QueryOptions<$Schema>> = $Result<$Schema, "Comments", Args, Options>;
